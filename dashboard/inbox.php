...
<div class="panel panel-default">    
    <div class="panel-body">
        <div class="inbox-center table-responsive">
			...
			<?php
			$max_per_page = 20; //Max results per page
			...
			if($countarr>0)
			{
				...
				<label for="checkbox0"></label>    
					...
					<a href="javascript:void(0);"><span class="btn-name"> <?php if($msgvlue['message_status']==2) ?><?php echo $msgvlue['from_name'];?><?php if($msgvlue['message_status']==2) ?></span> <span class="label label-info m-r-10"><?php echo $msgvlue['from_role'];?></span> <?php echo $msgvlue['subject'];?>..</a>
					</td>
						  ...
						  ?>
							<div class="row message-gap">  
								<div class="<?php echo $firsttag;?> col-sm-12 <?php echo $sectag;?>-arrow pull-<?php echo $sectag;?>"> 
									...
									{
									?>
										<strong class="text-left btn-block">Attachment:  <a href="<?php echo HTTP_SERVER."".$_SESSION['USER']['DB_NAME'].'/uploads/msg/'.$msgvlued['attachment'].'';?>"><span class="fa fa-download"></span> <?php echo $msgvlued['attachment'];?></a></strong>
									<?php
									}
									?>
								</div>    
                ...
                <tr>
                    <th colspan="6">
                        <nav aria-label="Page navigation" class="text-center">
						  ...
						  {
						  ?>
							<li class="<?php if(isset($_REQUEST['page'])==1 || isset($_REQUEST['page'])=='') echo 'active'; ?>"><a href="<?php echo HTTP_SERVER."".'dashboard/principal/inbox.php?page='.$i.'';?>" id="<?php echo $i; ?>" class="paging"><?php echo $i;?></a></li>
						<?php
						}
						?>
						
							<!--<li class="<?php if(isset($_REQUEST['page'])==1 || isset($_REQUEST['page'])=='') echo 'active'; ?>"><a href="<?php echo HTTP_SERVER."".'dashboard/principal/inbox.php?page=1';?>" id="1" class="paging">1</a></li>
                            <li class="<?php if(isset($_REQUEST['page'])==2) echo 'active'; ?>"><a href="<?php echo HTTP_SERVER."".'dashboard/principal/inbox.php?page=2';?>" id="2" class="paging">2</a></li>
                            <li class="<?php if(isset($_REQUEST['page'])==3) echo 'active'; ?>"><a href="<?php echo HTTP_SERVER."".'dashboard/principal/inbox.php?page=3';?>" id="3" class="paging">3</a></li>
                            <li class="<?php if(isset($_REQUEST['page'])==4) echo 'active'; ?>"><a href="<?php echo HTTP_SERVER."".'dashboard/principal/inbox.php?page=4';?>" id="4" class="paging">4</a></li>
                            <li class="<?php if(isset($_REQUEST['page'])==5) echo 'active'; ?>"><a href="<?php echo HTTP_SERVER."".'dashboard/principal/inbox.php?page=5';?>" id="5" class="paging" id="paging">5</a></li>
                            <li>
...
<input type="hidden" name="from_role" value="Principal">
                                ...
                                <div class="form-group marg-bott">
                                    ...
                                    <div class="col-sm-10">
                                        <label class="btn btn-default btn-color border-round marg-right">
                                            <span class="fa fa-paperclip"></span> Browse<input type="file" name="attach" style="display: none;" class="upload-file">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">     
              ...
              <div class="form-group">
				...
				<input type="hidden" id="from_role" value="Principal" name="from_role">
