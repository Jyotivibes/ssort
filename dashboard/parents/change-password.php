                        ...
                        <section class="">
                            <div class="row">
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    <div class="">
                                        <form class="form-horizontal" onsubmit="return validationfunt();" method="POST"
                                            ...
                                            <div class="form-group">
                                                <label for="inputPassword4" class="col-sm-3 control-label">Enter New
                                                    Password <font color="red">*</font></label>

                                                <div class="col-sm-9">
                                                    <input value="<?php echo @$_POST['n_pass']; ?>" class="form-control password"
                                                           id="new_pass" placeholder="" name="n_pass" type="password">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="inputPassword4" class="col-sm-3 control-label"  style="font-size:13px;">Re-Enter New
                                                    Password <font color="red">*</font></label>

                                                <div class="col-sm-9">
                                                    <input class="form-control password" id="r_pass" name="r_n_pass"
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-offset-3 col-sm-9">
                                                    <div class="c_change_pass">
                                                        Password must be minimum of 7 characters long & contain at least
                                                        1 letter & 1 number
                                                    </div>
                                                </div>
                                            </div>
...
<script>
    function validationfunt() {
        if ($('#new_pass').val() == '') {
            ...
            document.getElementById('alertmsg').innerHTML = 'Please enter confirm Password';
            $('#r_pass').focus();
            return false;
        }
