																			...
																			<div class="col-md-4 col-sm-4 col-xs-12">
                                                                                ...
                                                                                <div class="row col-sm-3 pull-right mar-top">
                                                                                    <div class="input-group">
                                                                                        ...
                                                                                        <input type="button" class="all-btm form-control" aria-label="Approve" value="Approve">
                                                                                        <span class="input-group-addon">
                                                                                         <input type="checkbox" aria-label="Approve">
                                                                                    </span>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <table class="table table-bordered">
																					...
																					?>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td><a href="#"><img src="../../<?php echo $_SESSION['USER']['DB_NAME'];?>/uploads/<?php echo $rvlue['usr_pic'];?>"></a>
                                                                                            </td>
