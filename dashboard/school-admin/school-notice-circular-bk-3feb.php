    ...
    <div class="modal fade" id="myModales" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <br><small>(Only PDF/JPEG Files)</small>
                        </div>
                    </div>
                   <div class="form-group">
                        <label class="control-label col-sm-3 " for="pwd">Valid Till:</label>
                       <div class="col-sm-9">
						<input class="form-control mydatepicker date_form" placeholder="Valid Till" name="date_form" type="text">
						</div>
                    </div>
                    <br>
                    <br>
				...
				<div class="modal-footer">
					<input type="submit" class="btn btn-default" value="Submit" name="SubmitSNC">
