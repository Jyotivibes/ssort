						...
						<div class="col-md-8 col-sm-8 col-xs-12">
							<div class="">
								<form class="form-horizontal" onsubmit="return validationfunt();"  method="POST"  action="<?php echo $_SERVER['PHP_SELF']; ?>" >
									...
									<div class="form-group">
										<label for="inputPassword4" class="col-sm-3 control-label">Enter New Password </label>
										<div class="col-sm-9">
											<input value="<?php echo @$_POST['n_pass']; ?>" class="form-control" id="new_pass" placeholder="" name="n_pass" type="password">
										</div>
									</div>
                                    <div class="form-group">
                                        <label for="inputPassword4" class="col-sm-3 control-label">Re-Enter New Password </label>
                                        <div class="col-sm-9">
                                            <input class="form-control" id="r_pass" name="r_n_pass" placeholder="" type="password">
                                        </div>
                                    </div>
									<div class="form-group">
										<div class="col-sm-offset-3 col-sm-9">
                                            <div class="c_cursor_pointer_show_pass">
											     <i class="fa fa-eye"></i>
