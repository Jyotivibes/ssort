    ...
    <div id="wrapper">
        ...
        if(isset($_SESSION['USER']['USER_NAME']) && !empty($_SESSION['USER']['USER_NAME']) && !empty($_SESSION['USER']['ROLE_ID']) && ($_SESSION['USER']['ROLE_ID']=='SAD') )
        {
			...
			#######GET ALL MESSAGES##################
				...
				$sqlmsgs = $obj->VIEWALLMESSAGE($_SESSION['USER']['USER_ID'],'Admin',$page,$type,$records);
				$countarr = $obj->getnoofmessages($_SESSION['USER']['USER_ID'],'Admin',$page,$type,$records);
			#######GET ALL MESSAGES##################
    ...
    <tr>
        <th colspan="6">
            <nav aria-label="Page navigation" class="text-center">
                ...
                <ul class="pagination">
                    <li>
                        <a class="<?php if($pagedata==1) echo'btn disabled'; ?>" href="<?php echo HTTP_SERVER."".'dashboard/school-admin/school-inbox.php?page='.$start.'&type='.$typeurl.'&records='.$max_per_page.'';?>" aria-label="Previous">
                    ...
                    {
                        ?>
                        <li class="<?php if($pagedata==$i) {echo 'active';} else {echo '';}?>"><a href="<?php echo HTTP_SERVER."".'dashboard/school-admin/school-inbox.php?page='.$i.'&type='.$typeurl.'&records='.$max_per_page.'';?>" id="<?php echo $i;?>" class="paging"><?php echo $i;?></a></li>
                        <?php
                    }
                    ?>
							<li>
                                <a class="<?php if($pages==$pagedata) echo'btn disabled'; ?>" href="<?php echo HTTP_SERVER."".'dashboard/school-admin/school-inbox.php?page='.$end.'&type='.$typeurl.'&records='.$max_per_page.'';?>" aria-label="Next">
                                    <span aria-hidden="true">»</span>
                                </a>
                            </li>
                        </ul>
