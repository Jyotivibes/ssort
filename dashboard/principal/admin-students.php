                                        ...
                                        <tr>
                                            ...
                                            <td><a href="student-profile.php?stu_id=<?php echo $stuvar['stu_id']; ?>"><img
                                             ...
                                             <td class="text-center">
                                                 <?php echo '<a href="#"  class="editattend"  data-id="'.$stuvar['att_id'].'" data-user="'.$stuvar['att_ref_id'].'" data-in="'.$stuvar['att_intime'].'" data-out="'.$stuvar['att_outtime'].'" >
                ...
                <tbody class="c_teach_tabel" id="studentfee">
                    ...
                    foreach ($stuidarr as $stufeevalue) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="../principal/fees.php?id=<?php echo $stufeevalue['ID'];?>"> <i class="fa fa-eye view_btn"
        ...
        <div class="modal-content">
          ...
          <form class="form-inline" method="post" action="">
            <div class="modal-body">
                ...
                <input class="form-control" value="09:30" type="hidden" id="id" name="id">
...
<script type="text/javascript">
    $(".elementnme").bind("change keyup", function(e) {
        ...
        var dataString = 'element=' + txtElement + '&session=' + session + '&class=' + classv + '&section=' + secv + '&date=' + date + '&sessionstartdate='+sessionstartdate+' &sessionrange='+sessionrange+' &action=' + action;
        $.ajax({
            type: 'POST',
            data: dataString,
            url: '../../ajax.php',
...
<script>
    ...
    $(".selattside").change(function (e) {
        ...
        var dataString = 'element=' + txtElement + '&session=' + session + '&salyear=' + selyear + '&session_start_date=' + session_start_date + '&action=' + action;
        ...
        $("#section2").change(function () {
            ...
            $.ajax({
                ...
                data: {
                    classes: classes,
                    section: section,
					role :'<?php echo $_SESSION['USER']['ROLE_ID']; ?>'
                },
                success: function (data) {
