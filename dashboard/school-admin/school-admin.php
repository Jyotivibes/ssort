                              ...
                              while ($row = mysql_fetch_array($eventNotification)) {
                                         ...
                                         <div class="alert alert-<?php echo $tag; ?> margin-btm-5 clearfix alert-height">
                                             <div class="notification-info">
                                                 <ul class="clearfix notification-meta event-sub">
									...
									foreach($leavearray as $leavevlue)
									{
										...
										<tr>
											<td><?php echo $leavevlue['USERFNAME'];?></td>
											 <td><?php echo date('d-m-Y', strtotime($leavevlue['minoff']));?></td>
											<td><?php echo date('d-m-Y', strtotime($leavevlue['maxoff']));?></td>
											<td>
												<a href="#id" data-toggle="modal" class="staffLeave"
                                                   data-reason="<?php echo $leavevlue['leave_reason']; ?>"
                                                   data-from="<?php echo date('d-m-Y', strtotime($leavevlue['minoff'])); ?>"
                                                   data-to="<?php echo date('d-m-Y', strtotime($leavevlue['maxoff'])); ?>"
                                                    >
