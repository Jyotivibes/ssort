...
<div class="panel panel-default">    
    <div class="panel-body">
        <div class="inbox-center table-responsive">
			...
			?>
            <tr class="unread accordion-toggle" data-toggle="collapse" data-target="#message-open<?php echo $i;?>" style="cursor: pointer;">
            <td>
            <div class="checkbox m-t-0 m-b-0">
                    ...
                    <th colspan="6">
                        <nav aria-label="Page navigation" class="text-center">
                          <ul class="pagination">
                            ...
                            <li class="<?php if($_REQUEST['page']==1 || $_REQUEST['page']=='') echo 'active'; ?>"><a href="<?php echo HTTP_SERVER."".'dashboard/parents/inbox.php?page=1';?>" id="1" class="paging">1</a></li>
                            <li class="<?php if($_REQUEST['page']==2) echo 'active'; ?>"><a href="<?php echo HTTP_SERVER."".'dashboard/parents/inbox.php?page=2';?>" id="2" class="paging">2</a></li>
                            <li class="<?php if($_REQUEST['page']==3) echo 'active'; ?>"><a href="<?php echo HTTP_SERVER."".'dashboard/parents/inbox.php?page=3';?>" id="3" class="paging">3</a></li>
                            <li class="<?php if($_REQUEST['page']==4) echo 'active'; ?>"><a href="<?php echo HTTP_SERVER."".'dashboard/parents/inbox.php?page=4';?>" id="4" class="paging">4</a></li>
                            <li class="<?php if($_REQUEST['page']==5) echo 'active'; ?>"><a href="<?php echo HTTP_SERVER."".'dashboard/parents/inbox.php?page=5';?>" id="5" class="paging" id="paging">5</a></li>
                            <li>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">     
              ...
              <div class="form-group">
				...
				<input type="hidden" id="from_role" value="Parent" name="from_role">
