...
<head>
    ...
    <title>School Management Solutions - SMS | Admin Students</title>
                ...
                <div class="row bg-title">
                    ...
                    <div class="col-lg-3 col-sm-3 col-md-3 col-xs-12">
                        <ol class="breadcrumb bread-change">
                            ...
                            <li class="active">Admin Student</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
						...
						<div class="my-box clearfix">
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="form-group">
								  <select class="form-control" id="sel1">
									<option>Md Imtesal Ahmad</option>
                                                                                ...
                                                                                <table class="table table-bordered">
                                                                                    ...
                                                                                    <tbody class="c_teach_tabel">
                                                                                        <tr>
                                                                                            <td class="text-center">1</td>
                                                                                            <td>Abhi Singh</td>
                                                                                            <td><a href="../principal/profile.php"><img src="../images/father-pic.jpg"></a>
                                                                                            </td>
                                                                                            <td>101162</td>
                                                                                            <td>25000</td>
                                                                                            <td>25-11-2016</td>
                                                                                            <td>12000</td>
                                                                                            <td>
                                                                                              <a href="../principal/fees.php" >  <i class="fa fa-eye view_btn" aria-hidden="true"></i></a>
