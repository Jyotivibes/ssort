...
if(isset($_SESSION['USER']['USER_NAME']) && !empty($_SESSION['USER']['USER_NAME']) && !empty($_SESSION['USER']['ROLE_ID']) && ($_SESSION['USER']['ROLE_ID']=='SAD') )
{
    ...
    $stuarray=mysql_fetch_array(mysql_query("SELECT * FROM essort_user_relation WHERE stu_id='".$_REQUEST['id']."'"));
    $stuadata=mysql_fetch_array(mysql_query("SELECT * FROM essort_application_header WHERE usr_application_id='".$stuarray['stu_id']."'"));
    $sql=mysql_query("SELECT *,'element_name' FROM essort_fee_structure WHERE class_id='".$stuarray['class_id']."' AND sec_id='".$stuarray['sec_id']."'");
    $element=array();
...
#############################SELECT FEE###################################################################	
    ...
    $sqlfeetrans=mysql_query("SELECT * FROM essort_fee_transaction WHERE user_id='".$stuarray['stu_id']."' AND fee_quarter='".$type."'");
...
########################################################PENDING DUES###########################################################################
    if($type=='fourth')
    {
        ...
        for($i=1;$i<=$count;$i++)
        {
		 ...
		 $sqlpendingdues=mysql_query("SELECT * FROM essort_fee_transaction WHERE user_id='".$stuarray['stu_id']."' AND fee_quarter='third'");
        ...
        //SECOND QUARTER
        $sqlpendingsdues=mysql_query("SELECT * FROM essort_fee_transaction WHERE user_id='".$stuarray['stu_id']."' AND fee_quarter='second'");
        ...
        //FIRST QUARTER
		$sqlpendingfdues=mysql_query("SELECT * FROM essort_fee_transaction WHERE user_id='".$stuarray['stu_id']."' AND fee_quarter='first'");
    ...
    elseif($type=='third')
    {
        ...
        $penality=0;
        //SECOND QUARTER
        $sqlpendingsdues=mysql_query("SELECT * FROM essort_fee_transaction WHERE WHERE user_id='".$stuarray['stu_id']."' AND fee_quarter='second");
        $fee_pending_nos_of_rows=mysql_num_rows($sqlpendingsdues);
        if($fee_pending_nos_of_rows==0)
        {
            $pendingsquarter=1;
        ...
        //FIRST QUARTER
        $sqlpendingfdues=mysql_query("SELECT * FROM essort_fee_transaction WHERE WHERE user_id='".$stuarray['stu_id']."' AND fee_quarter='first");
        $fee_pending_nof_of_rows=mysql_num_rows($sqlpendingfdues);
        if($fee_pending_nof_of_rows==0)
        {
            $pendingfquarter=1;
	...
	elseif ($type == 'first') {
        $amount = 0;
        //FIRST QUARTER
        $sqlpendingfdues = mysql_query("SELECT * FROM essort_fee_transaction  WHERE user_id='" . $stuarray['stu_id'] . "' AND fee_quarter='first' AND status=1");
		$pendingsquarter=1;
		$pendingtquarter=1;
		$pendingfrquarter=1;
        $fee_pending_nof_of_rows = mysql_num_rows($sqlpendingfdues);
	...
	#####################################FEE DISCOUNT###############################################
	$sqldiscount=mysql_query("SELECT * FROM `essort_fee_discount` WHERE stu_id='".$stuarray['stu_id']."' GROUP BY discount_quarter");
	$discountarr=array();
...
#####################################FEE HISTORy###############################################
    $classname=$obj->getClass($stuarray['class_id']);
    $sectionname=$obj->getSection($stuarray['class_id'],$stuarray['sec_id']);
    $sqlfee=mysql_query("SELECT * FROM  essort_fee_transaction WHERE user_id='".$stuarray['stu_id']."'");
    $feetransarr=array();
                                ...
                                if(count($feetransarr)>0)
                                {
                                    foreach($feetransarr as $feetransvlue)
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="fa fa-inr"></span><?php echo $feetransvlue['payment_amount_by_user'];?></td>
                                            <td class="text-center"><a href="javascript:void(0)" data-toggle="tooltip" data-date="<?php echo date('d M , Y',strtotime($feetransvlue['fee_created_on']));?>"
                                                                       data-tag="<?php echo $tag;?>" class="fee_pdf" data-original-title="Download Receipt"><span class="fa fa-download"></span></a></td>
                                        </tr>
                                    <?php
                                    }
                                }
    ...
    <div class="panel-heading bg-accordian">
        <h4 class="panel-title">
            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
                ...
                <span class="pull-right text-fff"><?php echo  $fquarter['ftime_sdate'];?> - <?php echo  $fquarter['ftime_edate'];?> </span>
            </a>
        ...
        <div class="panel-body">
            <div class="table-responsive">
                <table class="table color-table primary-table" id="collapse1">
                    ...
                    <tr>
                        <td colspan="4">
                            <a class="btn btn-link text-muted text-fancy btn-block text-center">Payment date: <?php echo  $fquarter['ftime_sdate'];?> - <?php echo  $fquarter['ftime_edate'];?></a>
                        </td>
                    </tr>
                    </tbody>
                </table>
    ...
    <div class="panel-heading bg-accordian">
        <h4 class="panel-title">
            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
                ...
                <span class="pull-right text-fff"><?php echo  $squarter['ftime_sdate'];?> - <?php echo  $squarter['ftime_edate'];?></span>
            </a>
        </h4>
    </div>
        ...
        <div class="panel-body">
            <div class="table-responsive">
                <table class="table color-table primary-table" id="collapse2">
                    ...
                    <tr>
                        <td colspan="4">
                            <a class="btn btn-link text-muted text-fancy btn-block text-center">Payment date: <?php echo  $squarter['ftime_sdate'];?> - <?php echo  $squarter['ftime_edate'];?> </a>
                        </td>
                    </tr>
                    </tbody>
                </table>
    ...
    <div class="panel-heading bg-accordian">
        <h4 class="panel-title">
            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseThree">
                ...
                <span class="pull-right text-fff"><?php echo  $tquarter['ftime_sdate'];?> - <?php echo  $tquarter['ftime_edate'];?></span>
            </a>
        </h4>
    </div>
        ...
        <div class="panel-body">
            <div class="table-responsive">
                <table class="table color-table primary-table" id="collapse3">
                    ...
                    <tr>
                        <td colspan="4">
                            <a class="btn btn-link text-muted text-fancy btn-block text-center">Payment date: <?php echo  $tquarter['ftime_sdate'];?> - <?php echo  $tquarter['ftime_edate'];?></a>
                        </td>
                    </tr>
                    </tbody>
                </table>
    ...
    <div class="panel-heading bg-accordian">
        <h4 class="panel-title">
            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseFourth">
                ...
                <span class="pull-right text-fff"><?php echo  $frthquarter['ftime_sdate'];?> - <?php echo  $frthquarter['ftime_edate'];?> </span>
            </a>
        </h4>
    </div>
        ...
        <section class="m-t-20">
            <div class="panel panel-default">
                <div class="panel-body text-center">
                    <a href="javascript:void(0);" class="btn btn-info bord-radius"><span class="fa fa-inr"></span><div id="totalfee"> 20,000</div></a>
                    ...
                    <div class="btn-block m-t-20">
                        <a class="btn btn-link text-muted text-fancy">Payment date: <?php echo  $frthquarter['ftime_sdate'];?> - <?php echo  $frthquarter['ftime_edate'];?></a>
                    </div>
                </div>
            </div>
            ...
            <div class="panel-group" id="accordiondue">
                <div class="panel panel-default">
                    <div class="panel-heading bg-accordian">
                        <h4 class="panel-title">
                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordiondue" href="#collapsedueOne">
                                Detail of Fee Due
                            </a>
                        </h4>
                    </div>
...
<div class="panel-group" id="accordion">
    <div class="panel panel-default">
        <div class="panel-heading bg-accordian">
            <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne1">Discount <span class="text-center pull-right"></span></a><!--20% Discount, Month January, February-->
            </h4>
        </div>
        ...
        <div id="collapseOne1" class="panel-collapse collapse">
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 new-section2">
                        ...
                        <div class="col-sm-12" id="show-meb">
                            <div class="funkyradio">
                                <div class="funkyradio-default">
                                    <input type="checkbox" name="checkbox" id="" <?php if (array_key_exists("first",$discountarr)) echo 'checked';?>>
                                    <label for="checkbox1">Q1</label>
                                </div>
                                <div class="funkyradio-default">
                                    <input type="checkbox" name="checkbox" id="" <?php if (array_key_exists("second",$discountarr)) echo 'checked';?>>
                                    <label for="checkbox1">Q2</label>
                                </div>
                                <div class="funkyradio-default">
                                    <input type="checkbox" name="checkbox" id="" <?php if (array_key_exists("third",$discountarr)) echo 'checked';?>>
                                    <label for="checkbox1">Q3</label>
                                </div>
                                <div class="funkyradio-default">
                                    <input type="checkbox" name="checkbox" id="" <?php if (array_key_exists("fourth",$discountarr)) echo 'checked';?>>
                ...
                <p class="mar-top"><div id="firstquartertagg"></div><div id="secquartertagg"></div><div id="thirdquartertagg"></div><div id="forthquartertagg"></div></p>
...
<div class="panel-group" id="accordion">
    <div class="panel panel-default">
        <div class="panel-heading bg-accordian">
            <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne2">Wave-off <span class="text-center pull-right"></span></a>
            </h4>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 new-section2 row">
                        ...
                        <div class="col-sm-12" id="show-mef">
                            <div class="funkyradio">
                                <div class="funkyradio-default">
                                    <input type="checkbox" name="" <?php if ((array_key_exists("first",$discountarr)) AND $discountarr['first']['discount_percent']=='100') echo 'checked';?>>
                                    <label for="checkbox1">Q1</label>
                                </div>
                                <div class="funkyradio-default">
                                    <input type="checkbox" name="" id="" <?php if ((array_key_exists("second",$discountarr)) AND $discountarr['first']['discount_percent']=='100') echo 'checked';?>>
                                    <label for="checkbox1">Q2</label>
                                </div>
                                <div class="funkyradio-default">
                                    <input type="checkbox" name="" id="" <?php if ((array_key_exists("third",$discountarr)) AND $discountarr['first']['discount_percent']=='100') echo 'checked';?>>
                                    <label for="checkbox1">Q3</label>
                                </div>
                                <div class="funkyradio-default">
                                    <input type="checkbox" name="" id="" <?php if ((array_key_exists("fourth",$discountarr)) AND $discountarr['first']['discount_percent']=='100') echo 'checked';?>>
                                    <label for="checkbox1">Q4</label>
                                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="pwd" value="" placeholder="ENTER Rs" readonly>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-3">
                        <div class="checkbox">
                            <label><input type="radio" name="messageticks"> Cash</label>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    <div class="col-sm-3">
                        <div class="checkbox">
                            <label>
                                <input type="radio" name="messageticks" id="messsageticks">Cheque</label>
                            <div class="contactmessages" style=display:none;>

                                <input type="text" name="setmessage" class="form-control" placeholder="Cheque Number">
                            </div>
                    ...
                    <div class="row" id="myDiv">
                        <div class="well col-xs-10 col-sm-10 col-md-12">
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-4">
                                    <a href="javascript:void(0);"><img src="<?php echo HTTP_SERVER; ?>/<?php echo $dbname; ?>/uploads/<?php echo $sch_logo; ?>" class="img-responsive" style="margin: 0 auto;" alt="School Name"></a>
                                </div>
                                <div class="col-xs-6 col-sm-6 col-md-4">
                                    <p class="text-center"><em><span>Date: </span><span id="receipt_date"></span></em></p>
