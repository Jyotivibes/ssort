								...
								<div class="row">
									<div class="col-md-2 col-xs-12">
                                        ...
                                        elseif(file_exists($filename)){
                                            ?>
                                            <img src="../images/<?php echo $data['usr_pic']; ?>" alt="Teacher" class="img-responsive img-rounded  img-thumbnail"/>
                                        <?php
                                        }
                                        else{
                                            ?>
