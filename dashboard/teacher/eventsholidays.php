                ...
                <form class="form-horizontal" name="frm" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" onsubmit="return classsectionValidate();" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input type="text" class="form-control event_date input-sm" id="date_form" name="date_form">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <!--------------calendar with icon st----------------->
                                <div class="input-group">
                                    <input type="text" class="form-control event_date input-sm" name="date_to" id="date_to">
                                    <a href="javascript:void(0)" class="input-group-addon"><span class="fa fa-calendar"></span></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group marg-bott ">
                        ...
                        <div class="col-sm-10 des-editor">
                            <textarea rows="5" style="width: 100%;" class="message" name="message" id="message"></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <div class="row">
...
<script>
    function classsectionValidate(){
        ...
        if(jQuery('#subject').val() ==''){
            document.getElementById('alertmsg').innerHTML='Please enter Subject';
            jQuery('#subject').focus();
            return false;
        }
        if(jQuery('#message').val() ==''){
            document.getElementById('alertmsg').innerHTML='Please enter Message';
