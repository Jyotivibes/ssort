...
<div id="wrapper">
<?php
if (isset($_SESSION['USER']['USER_NAME']) && !empty($_SESSION['USER']['USER_NAME']) && !empty($_SESSION['USER']['ROLE_ID']) && ($_SESSION['USER']['ROLE_ID'] == 'fee')) {
...
<div class="col-sm-6 col-xs-12">
<div class="my-box">
<h3 class="box-title box-title pad-b-10">Session: <?php echo CURRENT_SESSION;?></h3>
<section class="m-t-20">
<!--accordian st-->
        ...
        <form action="" method="post">
            ...
            <div class="modal-content">
                ...
                <form method="post" action="">
                    ...
                    <input type="hidden" name="stuid" value="<?php echo $_REQUEST['id']; ?>">
