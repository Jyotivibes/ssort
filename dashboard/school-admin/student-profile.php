...
##################################################FOR CLASS TEACHER#######################################################
    ...
    if(isset($_POST['submitpsd'])){
        ...
        if($resp == 1){
            ...
            $sms->CLI="SSORTDBAA";
            $sms->mobile=$_POST['mobile_no'];
            /*$sms->mobile=$_POST['mobile_no1'];*/
            $sms->message="Your Password is:- \n".$_POST['password'];
            $sms->accountName="vibescom";
            $sms_response = $sms->sendsms();
...
<h3 class="box-title box-title pad-b-10">Student Profile
    <div class="btn-group pull-right">
        ...
        <a href="" class="btn btn-defaul" data-target="#r_pass" data-toggle="modal">
        ...
        <div class="panel-wrapper collapse in">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <?php
                        $str=explode(' ',strtolower($sqlfather['usr_r_name']));
                        if($str[0]=='mr.' || $str[0]=='mr'){
                            $data=1;
                            $nam=null;
                            foreach($str as $text){
                                if($data==1){
                        ...
                        echo $sqlfather['usr_r_initial']." ".$nam;
                ...
                <tr>
                    ...
                    <td><strong>Middle Name </strong></td>
                    <td><?php $sqlfather['usr_r_mname']; ?></td>
                </tr>
                <tr>
                    <td align="center">3</td>
                    <td><strong>Last Name</strong></td>
                    <td><?php echo $sqlfather['usr_r_lname']; ?></td>
                </tr>
                <tr>
                    <td align="center">4</td>
                    <td><strong>Contact No.</strong></td>
                    <td><?php echo $sqlfather['usr_r_primary_contact'];?> </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <?php
                        $str1=explode(' ',strtolower($sqlmother['usr_r_name']));
                        if($str1[0]=='mrs.' || $str1[0]=='mrs'){
                            $data1=1;
                            $nam1=null;
                            foreach($str1 as $text1){
                                if($data1==1){
                                    //dont store
                                }else{
                                    $nam1.=$text1." ";
                        ...
                        echo $sqlmother['usr_r_initial']." ".$nam1;
                ...
                <tr>
                    <td align="center">2</td>
                    <td><strong>Middle Name </strong></td>
                    <td><?php echo $sqlmother['usr_r_mname'];?></td>
                </tr>
                <tr>
                    <td align="center">3</td>
                    <td><strong>Last Name </strong></td>
                    <td><?php echo $sqlmother['usr_r_lname'];?></td>
                </tr>

                <tr>
                    <td align="center">4</td>
                    <td><strong>Contact No. </strong></td>
                    <td><?php echo $sqlmother['usr_r_primary_contact'];?></td>
                </tr>
...
<!-------------------------SMS MODAL----------------------------->
<div class="modal fade" id="r_pass" role="dialog">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header-1">
            ...
            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="">
                <div class="modal-body">
                    <div id="alertmsg"></div>
                    <div class="form-group marg-bott">
                        <input type="hidden" value="<?php echo $sqlfather['usr_r_primary_contact']; ?>" name="mobile_no">
                        <label for="Enter New Password" class="col-sm-2 control-label">Password:</label>
                        <div class="col-sm-10">
                ...
                <div class="modal-footer">
                    <div class="row">
                        <div class="col-sm-12 col-xs-12 pull-right text-center">
                            <input type="submit" name="submitpsd" class="btn btn-default btn-color border-round" value="Send">
                            <!-- <i class="fa fa-paper-plane"></i> </button>-->
                        </div>
                    </div>
                </div>
