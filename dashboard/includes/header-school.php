...
require_once '../../classes/config.php';
	...
	$sch_local_address=$resultsch['sch_local_address'];
...
<div class="col-sm-1 logo-shift"> 
               <div class="top-left-part">
                    ...
                    <img src="<?php echo HTTP_SERVER; ?>/<?php echo $dbname; ?>/uploads/<?php echo $sch_logo;?>" style="height:50px;width:50px;"/>
                </a>
            </div>
</div>   <!--en col-->
...
<div class="school-loc">
    ...
    <p class="address"><?php echo $sch_local_address;?></p>  
        ...
        <li class="dropdown profile">
            <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown">
                <img alt="" src="../images/icons/profile.png">
                    <span class="username">Hello School Admin</span>
                    <b class="caret"></b>
                </a>
