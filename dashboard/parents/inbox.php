    ...
    <tr>
        <th colspan="6">
            <nav aria-label="Page navigation" class="text-center">
                ...
                <ul class="pagination">
                    <li>
                        <a class="<?php if($pagedata==1) echo'btn disabled'; ?>" href="<?php echo HTTP_SERVER."".'dashboard/parents/inbox.php?page='.$start.'&type='.$typeurl.'&records='.$max_per_page.'';?>" aria-label="Previous">
                    ...
                    {
                        ?>
                        <li class="<?php if($pagedata==$i) {echo 'active';} else {echo '';}?>"><a href="<?php echo HTTP_SERVER."".'dashboard/parents/inbox.php?page='.$i.'&type='.$typeurl.'&records='.$max_per_page.'';?>" id="<?php echo $i;?>" class="paging"><?php echo $i;?></a></li>
                        <?php
                    }
                    ?>
							<li>
                                <a class="<?php if($pages==$pagedata) echo'btn disabled'; ?>" href="<?php echo HTTP_SERVER."".'dashboard/parents/inbox.php?page='.$end.'&type='.$typeurl.'&records='.$max_per_page.'';?>" aria-label="Next">
                                    <span aria-hidden="true">»</span>
                                </a>
                            </li>
                        </ul>
