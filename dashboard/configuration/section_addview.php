				...
				<meta name="description" content="">
					<meta name="author" content="">
						<meta name="viewport" content="width=device-width, initial-scale=1">
							<title>School Management System - SMS | Add/View Section</title>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12 my-box">
                       <h4 class="h4">Add/View Section</h4>
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <a href="#" data-toggle="modal" data-target="#addNewClass" class="btn btn-info pull-right"><span class="fa fa-plus"></span> Add New Section</a>
                            </div>
                        </div>
                        <div class="row">
                         <div class="col-sm-12 col-xs-12">
        ...
        <div class="modal-body">     
           <div class="table-responsive">
              <table class="table addClassTable">
                ...
                <tbody>
                    <tr>                      
                        <td><input type="text" class="form-control input-sm" name="txtSection" placeholder="Section Name" /></td>
                    </tr>                    
                </tbody>
              </table>               
            </div>
        ...
        <div class="modal-footer">
          <div class="row">
            <div class="col-sm-12 col-xs-12 pull-right text-center">
                <input type="submit" class="btn btn-default btn-color border-round" value="Submit" name="SubmitS">
