...
<div class="row">
    <div class="col-sm-9 col-xs-12 my-box-11 fee-head shadow-a">
        <div class="col-sm-12">
            ...
            <div class="col-sm-3">
                <h5>Session <?php echo CURRENT_SESSION;?></h5>
            </div>
        </div>
        ...
        <div class="table-responsive twenty_three">
            <table class="table table-responsive panel-embose-c">
                ...
                foreach ($stuleaveidarrtoday as $stuvlue) {
                    ?>
                    <tr>
                        <td><?php echo $stuvlue['USERFANME'];?> <?php //echo $stuvlue['USERFANME'];?></td>
                        <td><?php echo $stuvlue['usr_role'];?></td>
                        <td><?php echo date('d-m-Y', strtotime($stuvlue['mindate'])); ?></td>
                        <td><?php echo date('d-m-Y', strtotime($stuvlue['maxdate'])); ?></td>
                        <td>
