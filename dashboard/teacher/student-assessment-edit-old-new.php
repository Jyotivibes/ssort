                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="table-responsive" id="report-book-grades">
                        <table class="table table-hover table-bordered">
						  ...
						  {
						  ?>
                            <tr id="subject-<?php echo $subvlaue['sub_id']; ?>">
...
$(".classval").keyup(function(){
		 ...
		 {
			//window.totalterm1English = parseInt(mynumber)+parseInt(totalterm2name+sub);
		 
		 }
		 
		 $("#TotalTerm1"+sub+"").val(totalterm1name+sub);
		 $("#TotalTerm2"+sub+"").val(totalterm2name+sub);
		 var grandtotal=parseInt(totalterm1name)+parseInt(totalterm2name);
