        ...
        <nav aria-label="Page navigation" class="text-center">
            <ul class="pagination">
					...
					$pages = ceil($countarr / $max_per_page);
						  ...
						  {
						  ?>
							<li class="<?php if(isset($_REQUEST['page'])==1 || isset($_REQUEST['page'])=='') echo 'active'; ?>"><a href="<?php echo HTTP_SERVER."".'dashboard/teacher/inbox.php?page='.$i.'';?>" id="<?php echo $i; ?>" class="paging"><?php echo $i;?></a></li>
						<?php
						}
						?>
            </ul>
