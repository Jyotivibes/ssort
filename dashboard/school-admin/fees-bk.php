...
#############################SELECT FEE###################################################################
   ...
   // echo $type;
    $sqlfeetrans = mysql_query("SELECT * FROM essort_fee_transaction WHERE user_id='" . $stuarray['stu_id'] . "' AND fee_quarter='" . $type . "' AND status=1");
...
########################################################PENDING DUES###########################################################################
    if ($type == 'fourth') {
        ...
        //echo "Gunda". "SELECT * FROM essort_fee_timeline WHERE ftime_equarter='fourth'";
        $now = time();
        ...
        $sqlpendingdues = mysql_query("SELECT * FROM essort_fee_transaction WHERE user_id='" . $stuarray['stu_id'] . "' AND fee_quarter='third' AND status=1");
        ...
        //SECOND QUARTER
        $sqlpendingsdues = mysql_query("SELECT * FROM essort_fee_transaction WHERE user_id='" . $stuarray['stu_id'] . "' AND fee_quarter='second' AND status=1");
...
#####################################FEE HISTORy###############################################
    ...
    $sqlfee = mysql_query("SELECT * FROM  essort_fee_transaction WHERE user_id='" . $stuarray['stu_id'] . "' AND status=1");
    $feetransarr = array();
...
<div class="row bg-title">
    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
        <h4 class="page-title">
            <span>News & Notifications – admission for 2017-2018 Starting from 15 November 2016.</span></h4>
    </div>
        ...
        <form action="" method="post">
            ...
            <div class="modal-content">
                ...
                <form method="post" action="">
                    ...
                    <input type="text" name="stuid" value="<?php echo $_REQUEST['id']; ?>">
                    <input type="text" class="form-control" name="quarterpopup" id="quarterpopup">
                    <input type="text" class="form-control" name="discountpopup" id="discountpopup">
                    <input type="text" class="form-control" name="penalitypopup" id="penalitypopup">
                    <input type="text" class="form-control" name="pendingpopup" id="pendingpopup">
