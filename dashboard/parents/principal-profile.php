                            ...
                            <div class="row">
                                <div class="col-md-2 col-xs-12">
                                    ...
                                    <?php
                                        ...
                                        ?>
                                        <img src="../images/<?php echo $sqlprincipal['usr_pic']; ?>" alt="Teacher"
                                             class="img-responsive img-rounded img-thumbnail"/>
                                    <?php
                                    } else {
                                        ?>
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" method="post" enctype="multipart/form-data"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <!--<input type="text" id="to_id" name="to_id" class="form-control" value="<?php echo $sqlprincipal['usr_email']; ?>" readonly="readonly">-->
                        </div>
                    </div>
                    <div class="form-group">
