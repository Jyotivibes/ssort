                                ...
                                <div class="row make-gap">    
                                    <div class="overlay-box">
                                        <div class="user-content text-center">
											...
											?>
                                                <img src="../images/<?php echo $rowprinc['usr_pic']; ?>" class="thumb-chairman-lg img-circle" alt="img"></a>
                            ...
                            <table class="table table-responsive panel-embose-c">
								...
								?>
                                    <tr>
                                        ...
                                        <td>                                           <a href="#id"><i class="view_btn fa fa-eye" aria-hidden="true"></i></a>

                                        </td>
                                        <td>
										<form action="" method="POST">
											<input type="hidden" value="<?php echo $stuvlue['leave_id'];?>" name="leave_id">
                                    ...
                                    <div class="notification-info">
                                        <ul class="clearfix notification-meta">
                                            <li class="pull-left notification-sender">
                                                <span class="alert-icon"><img src="../images/icons/event.ico" class="icon-size"></span> <span><a href="javascript:void(0);"><?php echo $cirvalue['occassion']?></a></span>
                                            </li>
                    ...
                    <div class="col-sm-6 col-xs-12">
                        ...
                        <div class="col-sm-12 col-xs-12 my-box-last shadow-a">
                            ...
                            <div class="feeds-principal-panel">
								...
								{
								?>
                                    <li data-toggle="modal" class="getdata" data-href="<?php echo $cirvlue['attachment']; ?>" data-subject="<?php echo $cirvlue['subject'];?>" data-id="<?php echo $cirvlue['message'];?>">
