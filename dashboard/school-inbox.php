...
<div class="panel panel-default">    
    <div class="panel-body">
        <div class="inbox-center table-responsive">
            ...
            <!--<button type="button" class="btn btn-info waves-effect waves-light border-round pull-right btn-trash typemsg" value="trash">Trash 
			...
			<?php
			$max_per_page = 20; //Max results per pag
			...
			if($countarr>0)
			{
				...
				<label for="checkbox0"></label>    
					...
					<a href="javascript:void(0);"><span class="btn-name"> <?php if($msgvlue['message_status']==2) ?><?php echo $msgvlue['from_name'];?> <?php if($msgvlue['message_status']==2)  ?></span></td>
                    ...
                    <th colspan="6">
                        <nav aria-label="Page navigation" class="text-center">
						 ...
						 <?php
						  ...
						  {
						  ?>
							<li class="<?php if(isset($_REQUEST['page'])==1 || isset($_REQUEST['page'])=='') echo 'active'; ?>"><a href="<?php echo HTTP_SERVER."".'dashboard/school-admin/school-inbox.php?page='.$i.'';?>" id="<?php echo $i;?>" class="paging"><?php echo $i;?></a></li>
						<?php
						}
						?>
                           <!-- <li class="<?php if(isset($_REQUEST['page'])==2) echo 'active'; ?>"><a href="<?php echo HTTP_SERVER."".'dashboard/school-admin/school-inbox.php?page=2';?>" id="2" class="paging">2</a></li>
                            <li class="<?php if(isset($_REQUEST['page'])==3) echo 'active'; ?>"><a href="<?php echo HTTP_SERVER."".'dashboard/school-admin/school-inbox.php?page=3';?>" id="3" class="paging">3</a></li>
                            <li class="<?php if(isset($_REQUEST['page'])==4) echo 'active'; ?>"><a href="<?php echo HTTP_SERVER."".'dashboard/school-admin/school-inbox.php?page=4';?>" id="4" class="paging">4</a></li>
                            <li class="<?php if(isset($_REQUEST['page'])==5) echo 'active'; ?>"><a href="<?php echo HTTP_SERVER."".'dashboard/school-admin/school-inbox.php?page=5';?>" id="5" class="paging" id="paging">5</a></li>
                            <li>
