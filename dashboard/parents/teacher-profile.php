...
<head>
    ...
    <title>School Management Solutions - SMS | Parents</title>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12">
                    <div class="my-box">
                        <h3 class="box-title box-title pad-b-10">Teacher Profile <a href="#"
                                                                                    class="btn btn-color pull-right"
                                                                                    data-toggle="modal"
                            ...
                            <div class="row">
                                <div class="col-md-2 col-xs-12">
                                    ...
                                    if ($classteacherdata['usr_pic'] == '') {
                                        echo '<img src="../images/images.png" alt="Teacher" class="img-responsive img-rounded img-thumbnail">';
                                    } else {

                                        echo '<img src="../images/' . $classteacherdata['usr_pic'] . '" alt="Teacher" class="img-responsive img-rounded img-thumbnail">';
                                    }
                                    ?>
                                </div>
                                        ...
                                        <div class="panel-wrapper collapse in">
                                            <table class="table table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $classteacherdata['usr_fname']; ?></td>
                                                </tr>
                                                <tr>
                                                    <td><strong>Middle Name </strong></td>
                                                    <td><?php echo $classteacherdata['usr_mname']; ?></td>
                                                </tr>

                                                <tr>
                                                    <td><strong>Last Name </strong></td>
                                                    <td><?php echo $classteacherdata['usr_lname']; ?></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $classteacherdata['usr_gender']; ?></td>
                                                </tr>
                                                <tr>
                                                    <td><strong>Date of Birth </strong></td>
                                                    <td><?php if ($classteacherdata['usr_dob'] == '') echo '-'; else echo date('d-m-Y', strtotime($classteacherdata['usr_dob'])); ?></td>
                                                </tr>

                                                <tr>
                                                    <td><strong>Marital Status </strong></td>
                                                    <td><?php echo $classteacherdata['usr_marital_status']; ?></td>
                                                </tr>
                                                <tr>
                                                    <td><strong>Qualification </strong></td>
                                                    <td><?php echo $classteacherdata['education']; ?></td>
                                                </tr>

                                                <tr>
                                                    <td><strong>Total Experience </strong></td>
                                                    <td><?php echo $classteacherdata['exp_yr']; ?></td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" method="post" enctype="multipart/form-data"
                    ...
                    <input type="hidden" name="to_role" value="Teacher">
                    <input type="hidden" name="teacher_id" value="<?php echo $classteacherdata['usr_id']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="to_id" name="to_id" class="form-control"
                                   value="<?php echo $classteacherdata['usr_email']; ?>" readonly="readonly">
                        </div>
                    </div>
                    <div class="form-group">
